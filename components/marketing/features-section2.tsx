      ...
      <div className="container">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-10 py-5">
          <div className="flex items-center">
            ...
            <ul className="space-y-8">
              {!!featureSet1 && featureSet1.map((item, i) => {
                return (
                  <li key={i}>
                    <div className="flex gap-4 text-left md:text-right sm:flex-row-reverse">
          ...
          <div className="flex justify-center items-center">
            <Image src="https://place-hold.it/340x480" alt="feature1-image" width={0} height={0} className="w-full" />
          </div>
          <div className="flex items-center">
            <div className="mx-auto">
            <ul className="space-y-8">
