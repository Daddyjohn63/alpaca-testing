...
const ExamplePage = async () => {
  ...
  return (
      ...
      <BreadCrumb items={breadcrumbItems} />
        <Heading
          title="Example"
          description="This is an example page showing how you can conditionally render content that is free vs paid."
        />
      {!hasAccess && (
        <CTAAlert title="Must be a paid user to get access" />
      )}
      {!!hasAccess && (
